...
public class MinumanAdapter extends RecyclerView.Adapter<MinumanAdapter.PresidenViewHolder> {
    ...
    @NonNull
    @Override
    public MinumanAdapter.PresidenViewHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater =
                LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_minuman, parent, false);
        return new PresidenViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull MinumanAdapter.PresidenViewHolder holder, int position) {
